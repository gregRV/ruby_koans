...
class AboutClassMethods < Neo::Koan
  ...
  # I think the first (self.method) would be good if you only have a few class
  # methods, whereas if you plan to have many class methods, the second
  # way may be preferred, and also groups the class methods so they're
  # not mixed with instance methods.
