...
class AboutIteration < Neo::Koan
  ...
  # Array#collect is same as Array#map
  ...
  # Array#select is same as Array#find_all
  ...
  # The arg passed to Array#inject is the base value
  ...
  # We don't need to store the contents of the file in a variable. What if it's a huge
  # file? Let's only go through it once with this format.
end
